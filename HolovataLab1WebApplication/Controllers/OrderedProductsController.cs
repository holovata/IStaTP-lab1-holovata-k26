...
namespace HolovataLab1WebApplication.Controllers
{
    public class OrderedProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,OrderId,Amount,Price,ColorId")] OrderedProduct orderedProduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,OrderId,Amount,Price,ColorId")] OrderedProduct orderedProduct)
        {
