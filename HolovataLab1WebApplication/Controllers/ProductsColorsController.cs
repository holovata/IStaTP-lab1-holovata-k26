...
namespace HolovataLab1WebApplication.Controllers
{
    public class ProductsColorsController : Controller
    {
        ...
        {
            ViewData["ColorId"] = new SelectList(_context.Colors, "Id", "Code");
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,ColorId,Availability")] ProductsColor productsColor)
        {
            ...
            ViewData["ColorId"] = new SelectList(_context.Colors, "Id", "Code", productsColor.ColorId);
            ViewData["ProductId"] = new SelectList(_context.Products, "Id", "Name", productsColor.ProductId);
            return View(productsColor);
        }
        ...
        {
          return (_context.ProductsColors?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
