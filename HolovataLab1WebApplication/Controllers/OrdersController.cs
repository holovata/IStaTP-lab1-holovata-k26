...
namespace HolovataLab1WebApplication.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            //ViewData["UserId"] = new SelectList(_context.Shops, "Id", "Address");
            //ViewData["UserId"] = new SelectList(_context.Users, "Id", "Address");
            ViewBag.UserId = userId;
            ViewBag.UserEmail = _context.Users.Where(o => o.Id == userId).FirstOrDefault().Email;
            ViewBag.UserName = _context.Users.Where(o => o.Id == userId).FirstOrDefault().Name;
            ViewBag.UserLastName = _context.Users.Where(o => o.Id == userId).FirstOrDefault().LastName;
            ViewBag.UserAddress = _context.Users.Where(o => o.Id == userId).FirstOrDefault().Address;
        ...
        public async Task<IActionResult> Create(int userId, [Bind("Id,UserId,ShopId,Time")] Order order)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Index", "Orders", new { id = userId, 
                    email = _context.Users.Where(o => o.Id == userId).FirstOrDefault().Email,
                    name = _context.Users.Where(o => o.Id == userId).FirstOrDefault().Name,
                    lastName = _context.Users.Where(o => o.Id == userId).FirstOrDefault().LastName,
                    address = _context.Users.Where(o => o.Id == userId).FirstOrDefault().Address
                });
            }
            //ViewData["UserId"] = new SelectList(_context.Shops, "Id", "Address", order.UserId);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Users, "Id", "Address", order.UserId);
            ViewData["ShopId"] = new SelectList(_context.Shops, "Id", "Address", order.ShopId);
